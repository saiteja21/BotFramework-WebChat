...
import { Composer, concatMiddleware, hooks } from 'botframework-webchat-component';
...
const BasicWebChat = ({
  ...
  return (
    <Composer
      ...
      {...otherProps}
    >
      <DOMComposer directLine={directLine} extraStyleSet={extraStyleSet} styleSet={styleSet}>
        <WebChatDOMContext.Consumer>
          {({ styleSet }) => (
            <TypeFocusSinkBox
