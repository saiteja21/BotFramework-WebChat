...
import WebChatUIContext from 'botframework-webchat-component/lib/WebChatUIContext';

const { useActivities, useDirection, useFocus, useRenderActivity, useRenderAttachment, useStyleOptions } = hooks;
...
const BasicTranscriptContent = ({ addScrollToEndListener, animating, scrollToEnd, sticky }) => {
  ...
  useEffect(() => addScrollToEndListener(scrollToEnd), [addScrollToEndListener, scrollToEnd]);
...
BasicTranscriptContent.propTypes = {
  addScrollToEndListener: PropTypes.func.isRequired,
  animating: PropTypes.bool.isRequired,
  scrollToEnd: PropTypes.bool.isRequired,
                  ...
                  <ScrollToBottomStateContext.Consumer>
                    {({ animating, sticky }) => (
                      <BasicTranscriptContent
                        addScrollToEndListener={addScrollToEndListener}
                        animating={animating}
